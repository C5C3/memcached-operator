// Package v1alpha1 contains DeepCopy independence tests for the Memcached and MemcachedList types.
package v1alpha1
...
func TestMemcachedDeepCopy_Independence(t *testing.T) {
	...
	*original.Spec.Image = "changed:latest"
	...
	// Mutate scalar status fields to confirm value copy.
...
func TestMemcachedDeepCopyObject_ReturnsRuntimeObject(t *testing.T) {
	...
	// Verify it is a different pointer.
	if mc == original {
