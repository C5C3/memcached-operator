// Package v1beta1 contains unit tests for scheme registration, GVK resolution,
// and type mapping of the Memcached v1beta1 API types.
package v1beta1
...
func TestScheme_GroupVersionFields(t *testing.T) {
	...
	if GroupVersion.Version != "v1beta1" {
		t.Errorf("expected GroupVersion.Version=%q, got %q", "v1beta1", GroupVersion.Version)
	}
}
